            ...
            <cfoutput>
                <div class="col-md-offset-3 col-sm-4 col-lg-4 col-xm-6 jumbotron text-center">
                    <div>
                        ...
                        <div class="row">
                            <a href="payment.cfm?addressAll" class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp Edit</a>
                            <cfif addressquery.recordCount GT 0>
                                <a href="payment.cfm?addressAll&linkAddress" class="btn btn-primary">New Address</a>
                                <a href="payment.cfm" class="btn btn-success">Proceed</a>
                            </cfif>
                        </div>
                    </div>
