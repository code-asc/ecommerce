...
<div class="text-center">
  ...
  #detailquery.customerAddress1#<br/>
  <cfif len(trim(detailquery.customerAddress2))>
  #detailquery.customerAddress2#<br/>
</cfif>
  #detailquery.customerCity#<br/>
  #detailquery.customerState#<br/>
  #detailquery.customerCountry#<br/>
  Ordered Date :#detailquery.orderDate#<br/>
  Total : Rs.<strong>#LsNumberFormat(precisionEvaluate(detailquery.orderAmount),"0.00")#</strong>
</div>
</div>
