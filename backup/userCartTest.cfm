...
<button value="#retrivecart.detailID#" class="increment"><i class="fa fa-plus" aria-hidden="true"></i></button>&nbsp Qty:<strong><p id="#retrivecart.detailID#" style="display:inline">#retrivecart.quantity#</p></strong>&nbsp <button value="#retrivecart.detailID#" class="decrement"><i class="fa fa-minus" aria-hidden="true"></i></button>
<br/><br/>
   <a href="userCartTest.cfm?removeFromCart=#retrivecart.detailID#" class="btn btn-warning"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp Remove From Bag</a>
