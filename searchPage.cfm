...
<div class="row">
  <cfquery name="retriveProduct">
    ...
    where Products.subCategoryID IN (<cfqueryparam value="1,2,3,11" cfsqltype="cf_sql_integer" list="true" >)
      ...
      <cfoutput>
            AND
            Brands.brandName LIKE <cfqueryparam value="%#url.brand#%" cfsqltype="cf_sql_varchar" >
              </cfoutput>
            </cfif>
            ...
            <div id="collapse2" class="panel-collapse collapse in" >
                      ...
                      <ul class="list-group">
                        <li class="list-group-item">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" value="Men-TopWear" name="checkCategory" class="checkCategory">
                               Men-TopWear
                            </label>
                          </div>
                        </li>
                        <li class="list-group-item">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" value="Men-BottomWear" name="checkCategory" class="checkCategory">
                               Men-BottomWear
                            </label>
                          </div>
                        </li>
                        <li class="list-group-item">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" value="Women-IndianWear" name="checkCategory" class="checkCategory">
                               Women-IndianWear
                            </label>
                          </div>
                        </li>
                        <li class="list-group-item">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" value="Women-WesternWear" name="checkCategory" class="checkCategory">
                                  Women-WesternWear
                            </label>
                          </div>
                        </li>
...
<!---<cfoutput>
  ...
  #url.subCategoryID#
    ...
    <script src="./script/categorySearchAjax.js"></script>
