...
subCategoryID=val;
  ...
  $("#thumbNailRow").append('<div class="col-sm-4 col-md-4 col-xm-4 col-lg-4"><a href="user_action.cfm?subCategoryID='+subCategoryID+'&checkBrand='+brandID+'"><div class="itemthumb"><img class="img-responsive" src="'+path+'"></div></a></div>');
});
}
